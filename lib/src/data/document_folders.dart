...
const String documentFoldersSvg =
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M546.773 389C503.303 482.878 408.257 548 298.002 548C187.746 548 92.7004 482.878 49.2305 389H546.773Z" fill="url(#paint1_linear_411_1556)"/>
...
const String documentFoldersSvgDark =
    '''<svg class="w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white" aria-hidden="true" width="600" height="548" viewBox="0 0 600 548" fill="none" xmlns="http://www.w3.org/2000/svg">
